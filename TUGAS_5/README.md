...
1. Install paket dengan command berikut ``sudo apt -y install apache2``
    ...
    > ![alt text](<assets/Screenshot 2024-04-14 025102.png>)
...
6. Reload service apache2
    ...
    > ![alt text](<assets/Screenshot 2024-04-14 031100.png>)
...
1. Install dengan perintah berikut
    ...
    > ![alt text](<assets/Screenshot 2024-04-14 032433.png>)
    > sudo apt -y install php8.2 php8.2-mbstring php-pear

2. Cek apakah sudah terinstall

    > ![alt text](<assets/Screenshot 2024-04-14 032735.png>)
...
1. Install dengan perintah berikut
    ...
    > ![alt text](<assets/Screenshot 2024-04-14 033132.png>)
...
1. Install paket dengan perintah berikut
    ...
    > ![alt text](<assets/Screenshot 2024-04-14 033801.png>)
...
3. Lakukan installasi dengan perintah ``sudo mysql_secure_installation``
    ...
    > ![alt text](<assets/Screenshot 2024-04-14 034235.png>)
...
3. Copy file config /usr/share/postfix/main.cf.dist ke /etc/postfix/main.cf
    ...
    > ![alt text](<assets/Screenshot 2024-04-14 035106.png>)
...
1. dengan perintah `telnet mail.kelompok2.local`
    ...
    > ![alt text](<assets/Screenshot 2024-04-14 195925.png>)
